        ...
        <form method="POST" action="{{ route('fornecedores.store') }}"
            ...
            <x-ui.card class="mb-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <x-ui.input name="nome_fantasia" label="Nome Fantasia" x-ref="nomeFantasia" value="{{ old('nome_fantasia') }}" hint="Opcional" />
                    <div>
            ...
            <x-ui.card class="mb-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        <x-ui.input name="email" type="email" label="E-mail" x-ref="emailField" value="{{ old('email') }}" :error="$errors->first('email')" />
                    </div>
