<x-layouts.app title="Contas a Receber">
    ...
    <x-ui.card :padding="false" x-data="{ selected: [], all: false }">
        ...
        <div x-show="selected.length > 0" x-cloak class="flex items-center gap-3 px-5 py-3 bg-green-50 dark:bg-green-900/20 border-b border-green-100 dark:border-green-800">
            <span class="text-sm font-medium text-green-700 dark:text-green-300" x-text="selected.length + ' selecionado(s)'"></span>
            <form method="POST" action="{{ route('contas-receber.baixa-massa') }}" class="flex items-center gap-2">
                @csrf
