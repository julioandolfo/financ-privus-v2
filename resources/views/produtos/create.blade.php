<x-layouts.app title="Novo Produto">
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                <h1 class="text-xl font-semibold text-surface-900 dark:text-white">Novo Produto</h1>
                <p class="text-sm text-surface-500 mt-0.5">Cadastre um produto ou serviço</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('produtos.store') }}"
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <x-ui.button type="submit">Salvar Produto</x-ui.button>
            </div>
        </form>
    </div>
